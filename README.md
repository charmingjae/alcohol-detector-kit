...
<br>
 <img src="" alt=""/>
* **프로젝트를 통해 LED와 부저를 통한 운전자의 음주여부를 시/청각화가 가능.**
* 시/청각화를 통해 운전자의 음주운전에 대한 경각심을 줄 수 있음.
* 시/청각화이기 때문에 차 주변 밖 사람들에 의한 음주운전 방지 효과 기대

* **텔레그램 메시지 전송이 가능.**
* 주변인들의 제지로 음주운전 방지 효과 기대.

* **라즈베리파이로 프로젝트 제작 가능.**
* 저가형이기 때문에 저렴한 비용으로 키트 제작 가능.
