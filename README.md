...
문제점과 해결과정
 <br>
<br>
1. __하드웨어적인 결함__ - 테스트 결과 정상적인 코드 실행에도 하드웨어적인 결함으로 사운드가 들리지 않는 문제
<br>
<br>
2. __보급의 문제__ - 서비스를 이용하기 위해서 해당 기기를 보급하여 차량에 설치해야 한다는 점과 차량내 인터넷이 활성화 되어야 하는 문제
<br>
 <br>
3. __제도,법률,도덕적인 문제__ - 서비스를 위한 기기를 운전자가 반드시 설치, 이용해야 한다는 제도,법률적인 조항이 없어,
 <br>
